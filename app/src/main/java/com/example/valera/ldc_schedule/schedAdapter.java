 ...
 * Just cut and modified version of Simple adapter
 */

public class schedAdapter extends BaseAdapter {
    ...
    public void setViewBackgroundColor(TextView v, @ColorInt int color) {
